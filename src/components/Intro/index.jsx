                ...
                <div className="
                    ...
                    <div className="text-white text-center flex flex-col gap-5">
                        <h3 className="
                            ...
                            ">Olá, somos uma Clínica de Desenvolvimento Infantil Lá Brinquê</h3>
                        <p className="
                            text-[19px] px-8
                    ...
                    <div className="
                        ...
                        <Link 
                            to="/sobre" 
                            className="
                                text-center bg-[#77B8A0] w-[180px] py-5 rounded-full
                        ...
                        <button 
                            className="
                                text-center bg-[#EF7811] w-[180px] py-5 rounded-full
